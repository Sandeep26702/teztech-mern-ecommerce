...
const Footer = () => {
  ...
  return (
    <footer className="relative pt-10 pb-6 mt-auto overflow-hidden font-sans text-gray-300 border-t border-gray-800 bg-gradient-to-b from-gray-900 to-black">
      
      {/* Background Glowing Orbs for Premium Vibe (from previous code) */}
      ...
      <div className="relative z-10 px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 gap-8 mb-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          {/* Changed col-span to 1, flex-row to place them exactly side-by-side */}
          <div className="flex justify-between gap-4 md:col-span-1">
            
            {/* Quick Links (Simple styling, no special animation here as requested) */}
            <div className="w-1/2">
            ...
            {/* Connect (The "Tadka Bhadka" Glassmorphism Side) */}
            <div className="w-1/2">
              <h4 className="relative inline-block mb-4 text-lg font-bold text-white">
                Connect
              ...
              <ul className="space-y-3">
                {/* Website */}
                <li>
                  <a href="https://teztech.in" target="_blank" rel="noopener noreferrer" className="flex items-center text-sm font-medium transition-all duration-300 outline-none text-slate-400 group hover:text-blue-400 focus:text-blue-400 hover:translate-x-2 focus:translate-x-2 active:scale-95">
                    <span className="flex items-center justify-center w-8 h-8 mr-3 transition-colors duration-300 border rounded-xl border-slate-700 bg-slate-800/50 group-hover:bg-blue-500/20 group-hover:border-blue-400 group-hover:shadow-[0_0_15px_rgba(59,130,246,0.5)]">
                ...
                {/* Email */}
                <li>
                  <a href="mailto:info@teztech.in" className="flex items-center text-sm font-medium transition-all duration-300 outline-none text-slate-400 group hover:text-rose-400 focus:text-rose-400 hover:translate-x-2 focus:translate-x-2 active:scale-95">
                    <span className="flex items-center justify-center w-8 h-8 mr-3 transition-colors duration-300 border rounded-xl border-slate-700 bg-slate-800/50 group-hover:bg-rose-500/20 group-hover:border-rose-400 group-hover:shadow-[0_0_15px_rgba(244,63,94,0.5)]">
                ...
                {/* WhatsApp */}
                <li>
                  <a href="https://wa.me/917801891805" target="_blank" rel="noopener noreferrer" className="flex items-center text-sm font-medium transition-all duration-300 outline-none text-slate-400 group hover:text-green-400 focus:text-green-400 hover:translate-x-2 focus:translate-x-2 active:scale-95">
                    <span className="flex items-center justify-center w-8 h-8 mr-3 transition-colors duration-300 border rounded-xl border-slate-700 bg-slate-800/50 group-hover:bg-green-500/20 group-hover:border-green-400 group-hover:shadow-[0_0_15px_rgba(34,197,94,0.5)]">
                ...
                {/* Telegram */}
                <li>
                  <a href="https://t.me/teztech" target="_blank" rel="noopener noreferrer" className="flex items-center text-sm font-medium transition-all duration-300 outline-none text-slate-400 group hover:text-sky-400 focus:text-sky-400 hover:translate-x-2 focus:translate-x-2 active:scale-95">
                    <span className="flex items-center justify-center w-8 h-8 mr-3 transition-colors duration-300 border rounded-xl border-slate-700 bg-slate-800/50 group-hover:bg-sky-500/20 group-hover:border-sky-400 group-hover:shadow-[0_0_15px_rgba(56,189,248,0.5)]">
          ...
          {/* 4. Location Map (Interactive Mobile & PC) */}
          <div>
            <h4 className="relative inline-block mb-4 text-lg font-bold text-white">
              Our Location
              <span className="absolute left-0 w-1/2 h-1 bg-blue-500 rounded-full -bottom-2"></span>
            </h4>
            <div tabIndex="0" className="relative h-40 overflow-hidden border border-slate-700 shadow-lg rounded-xl group focus:outline-none focus:ring-2 focus:ring-blue-500 hover:shadow-[0_0_20px_rgba(59,130,246,0.3)] transition-all">
              {/* Overlay that disappears on hover/focus to reveal map colors */}
              <div className="absolute inset-0 z-10 transition-opacity duration-300 pointer-events-none bg-gradient-to-t from-black/60 to-transparent group-hover:opacity-0 group-focus:opacity-0"></div>
  ...
  className="transition-all duration-500 opacity-70 group-hover:opacity-100 group-focus:opacity-100 group-active:opacity-100 grayscale group-hover:grayscale-0 group-focus:grayscale-0 group-hover:scale-110 group-focus:scale-110"
></iframe>
            </div>
          </div>
